...
for($i = 0; $i < count($partici_name); $i++){
    $user_picture[$i] = DB::table('users')->where('user_id',substr($partici_name[$i],0,-1))->get();
...
//확인 필요!!
    ...
    //   }
        ...
        // echo system("ffmpeg -i 20170626013731ssssua.mp3 -acodec libmp3lame -aq 4 -c:v copy hk.mp3");
        // echo system("rm 20170626013731ssssua.mp3");
    ...
    /*
        echo("<script>location.href='/BandChallenge/audioBefore';</script>");
    }*/
