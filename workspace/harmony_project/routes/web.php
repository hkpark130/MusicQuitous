...
// Route::get('/subweb','SubwebController@index');
...
|--------------------------------------------------------------------------
*/
Route::get('/rolling', function(){
  return view('menu/rolling');
});
Route::get('/video', function(){
...
// Route::get('/recordalbum',function(){
//   return view('board/BandChallenge_Record_Album');
// });
// 
...
//   return view('board/BandChallenge_Record_Albumn_View');
// });
...
// Route::get('/recordbefore',function(){
//   return view('board/BandChallenge_Record_Before');
// });
...
// 이전 오디오합주 합주후 게시물
// Route::get('/recordafter',function(){
//   return view('board/BandChallenge_Record_After');
// });

Route::get('/instselect',function(){
  return view('board/BandChallenge_Inst_Select');
});
...
//녹음 페이지
// Route::get('/recordwork',function(){
//   return view('board/BandChallenge_Record_Work');
// });
...
Route::get('/beforeview',function(){
  return view('board/BandChallenge_Record_Before_View');
});
...
// Route::get('/recordupload',function(){
//   return view('board/BandChallenge_Record_Upload');
// });
Route::get('/afterview',function(){
  return view('board/BandChallenge_Record_After_View');
});
Route::get('/recordmody',function(){
  return view('board/BandChallenge_Record_Mody');
});
Route::get('/recordjoin',function(){
  return view('board/BandChallenge_Record_Join');
});
Route::get('/progressbar',function(){
  return view('board/BandChallenge_Progressbar');
});
Route::post('/asd/video_upload','bandChallenge\BandChallengeController@bandChallenge_video_upload');
// Route::post('/bandChallenge/video_recording_write_send','bandChallenge\BandChallengeController@bandChallenge_video_recording_write_send');
// Route::get('/bandChallenge/videoWrite', function(){
//   return view('/bandChallenge/videoWrite');
// });
/*
|--------------------------------------------------------------------------
| 혜진 - Guild
