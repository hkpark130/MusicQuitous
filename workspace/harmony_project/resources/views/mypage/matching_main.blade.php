...
<body>
  ...
  <script>
  var instrumentsData=[
     {label:"Basic", value:"<?php echo $instruments["피아노"] ?>" ,color:"#3366CC"},
     {label:"Plus", value:"<?php echo $instruments["드럼"] ?>", color:"#DC3912"},
     {label:"Lite", value:"<?php echo $instruments["기타"] ?>", color:"#FF9900"},
     {label:"Elite", value:"<?php echo $instruments["신디사이저"] ?>", color:"#109618"}
  ...
  <div id="username" class="well">사용자 프로필</div>
  <div id="userGraph" class="well">사용자 그래프</div>
  <div id="Group">
    <div id="main">
        <ul>
            <div id="userimg">
                ...
                <p id="listuser">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<?php echo $countInstrument ?> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <?php echo $genres[$textGenres] ?> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<?php echo $instruments[$textInstruments] ?><br>
                &emsp;&emsp;&emsp;&emsp;연주한 곡수&emsp;&emsp;&emsp;&emsp;&emsp;<?php echo $textGenres; ?>&emsp;&emsp;&emsp;&emsp;&emsp; <?php echo $textInstruments; ?>
                </p>
            </div>
        </ul>
    </div>
  ...
  <div id="revision"><button onClick="changeData()" class="button1">변경</button></div>
  <!-- <a href="/">통계 더 보기</a> -->
  <button onClick="location.href='/matching/result';" class="button2">매칭하기</button>
  </div>
  <p id = 'footer'>
  <pre id = 'footer_text'>
