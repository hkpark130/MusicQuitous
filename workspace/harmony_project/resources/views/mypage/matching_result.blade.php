...
<body>
  ...
  <div id="div1" class="row">
   ...
   <div id ="title">매칭결과</div>
    ...
    <div id="div5">
    <p id="texts"><?php echo $user_id; ?>님과 취향이 맞는 음원</p>
         <!--<select id="sel">-->
    ...
    <div id="sel" class="container">
        ...
        <!--<option id="sel3">classic</option>-->
        <!--<option id="sel4">dance</option>-->
        <option id="sel11">rock</option> 
        <option id="sel2">pop</option> 
        <option id="sel3">classic</option>
        <option id="sel4">dance</option>
        </select> 
    </div>
    ...
    <p id="text"><?php echo $user_id; ?>님과 취향이 맞는 합주자</p>
      <!--<select id="test">-->
    ...
    <div class="col-md-12">
      <p id="maintext"><?php
      echo "{$user_id} 님이 자주 연주하는 음악의 장르는 '{$textGenres}' 이며 자주 연주하는 악기는 '{$textInstruments}'입니다.";
     ?></p>
    </div>
  </div>
  <p id = 'footer'>
