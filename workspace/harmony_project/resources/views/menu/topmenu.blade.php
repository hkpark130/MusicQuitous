...
<!--<script src="/js/jquery-3.2.1.min.js"></script>-->
  ...
  <div name="notice" style="display:none; position:fixed; bottom:0; right:0; height: 80px; width: 300px; border:5px solid black; z-index:1; overflow-x:hidden;">
      ...
      <audio name='my_news' style='display:none;' src='/news.mp3' controls>
      </audio>
  <script>
    ...
    function notice_update(){
      ...
      $.ajax({
        ...
        success:function(data){
         ...
         my_news[0].play();
          notice_td.innerHTML = "<a href='https://harmony-project-chonahoom.c9users.io/"+path+"'>"+name+" 님이 당신의 작품과 합주하였습니다.</a>";
