        ...
        <div class="col-md-12">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="buttonstyle ">
                            <form name="recordForm" id="recordForm" action="/recordwork" method="post">
                                ...
                                <input type='button' onclick="recordPage();" value='녹음'>
                                <input type='button' onclick="videoRecordPage();" value='녹화' >
                ...
                <div class="col-md-2 albumcontent ">
                    <div class="font">
                        <p title="musicname"><?php echo $midi['music_name'];?></p>
                          ...
                          foreach ($insts as $inst){
                              ...
                              echo "
                                 ...
                                 <div class='listborder '>
                                    <img src='/img/base.png'/><div class='namealign '>".substr($inst['inst_name'],0,-4)."</div>
                                        <div class='checkbox'>
