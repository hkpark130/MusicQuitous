    ...
    */
    ...
    .range-slider__value:after {
     ...
     button.replace {    /*button tag 에 원하는 스타일 적용*/
        ...
        height:55px;
        border:none;
        background:url("/img/RecordingStudio/파일선택.png");
        background-size: 100%
        cursor: pointer;
    }
    input.upload {  
                ...
                <div class="col-md-6 recordbox">
                    ...
                    <div class="row bpmbox">
                        ...
                        <div class="col-md-2 numerical">
                            <button type="button" id="bpmStop" onclick="bpmStop()"><img src="/img/RecordingStudio/BPM정지.png"></button>
                        </div>
                    </div>
                    ...
                    <div class="row step_box">
                       ...
                       <button type="button" class="sub" onclick="file_up()" style="margin:10px;">
                           <img src="/img/RecordingStudio/전송.png">
                        </button>
